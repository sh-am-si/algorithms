        ...
        if pattern[j] != text[i + j]:
            ...
            if (
                ...
                if text[i + j] in pattern[0:j]:
                    ...
                    # i+j is index of bad character, this line is used for jumping pattern to match
                    # bad character of text with same character in pattern
                else:
                    i = (
                        i + j + 1
                ...
                if text[i + j] in pattern[0:j]:
                    ...
                    # i+j is index of bad character, this line is used for jumping pattern to match bad character
                    # of text with same character in pattern
                else:
                    bcshift = i + j + 1
